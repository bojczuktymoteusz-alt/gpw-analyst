                ...
                <div className="container mx-auto px-6 h-20 flex items-center justify-between">
                    <div className="flex items-center gap-3 group">
                        <div className="relative">
                            ...
                            <div className="relative bg-gradient-to-br from-indigo-500 to-purple-600 p-2.5 rounded-xl text-white shadow-xl">
                                <TrendingUp size={24} />
                            </div>
                        </div>
                        <div>
                ...
                <div className="mb-10 flex flex-col md:flex-row md:items-end justify-between gap-6">
                    <div>
                        <div className="flex items-center gap-2 mb-2">
                            ...
                            <span className="text-xs font-bold uppercase tracking-widest text-indigo-500">Analiza w Czasie Rzeczywistym</span>
                            {isPredicting && (
                                <span className="text-[10px] font-bold uppercase text-indigo-400 animate-pulse ml-2 flex items-center gap-1">
                                    <Activity size={12} /> AI Przelicza...
                                </span>
                            )}
                        </div>
